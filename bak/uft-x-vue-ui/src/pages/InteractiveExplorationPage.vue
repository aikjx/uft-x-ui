      ...
      <div class="exploration-layout">
        ...
        <div class="control-panel">
          <div class="panel-section">
            ...
            <!-- 引力场参数 -->
            <div
              v-if="selectedFieldType === 'gravity' || selectedFieldType === 'unified'"
              class="control-group"
            >
            ...
            <!-- 电磁场参数 -->
            <div
              v-if="selectedFieldType === 'electromagnetic' || selectedFieldType === 'unified'"
              class="control-group"
            >
            ...
            <div class="control-group">
              ...
              <div class="parameter-item checkbox">
                <input type="checkbox" id="showFieldLines" v-model="visualOptions.showFieldLines" />
                <label for="showFieldLines">显示场线</label>
              </div>

              <div class="parameter-item checkbox">
                <input type="checkbox" id="showParticles" v-model="visualOptions.showParticles" />
                <label for="showParticles">显示粒子轨迹</label>
              </div>

              <div class="parameter-item checkbox">
                <input type="checkbox" id="showGrid" v-model="visualOptions.showGrid" />
            ...
            <div class="control-buttons">
              ...
              <button class="btn btn-secondary" @click="resetParameters">重置参数</button>
              <button class="btn btn-tertiary" @click="saveConfiguration">保存配置</button>
            </div>
          </div>
...
<script setup lang="ts">
  ...
  // 统一场公式
  const unifiedFieldFormula =
    '\\mathcal{L} = \\frac{1}{16\\pi G} R - \\frac{1}{4} F_{\\mu\\nu}F^{\\mu\\nu} + \\lambda (F_{\\mu\\nu}F^{\\mu\\nu})^2 + \\alpha R F_{\\mu\\nu}F^{\\mu\\nu}'
  ...
  const maxFieldIntensity = computed(() => {
    if (selectedFieldType.value === 'gravity') {
      ...
      return (
        (gravityParams.fieldStrength + electroParams.fieldStrength) *
        unifiedParams.couplingConstant *
        0.5
      )
    }
  })
