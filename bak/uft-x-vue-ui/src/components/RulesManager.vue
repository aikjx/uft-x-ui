<template>
  <div class="rules-manager">
    ...
    <div class="rules-header">
      <t-input v-model="searchQuery" placeholder="搜索规则..." clearable class="search-input">
      ...
      <div class="filter-controls">
        ...
        <t-button @click="addRule" class="add-rule-btn"> <t-icon name="add" /> 添加规则 </t-button>
      </div>
    </div>

    <!-- 规则列表 -->
    <div class="rules-list">
      <t-table :data="filteredRules" :columns="columns" row-key="id" hover stripe size="medium">
        <!-- 规则状态 -->
    ...
    >
      <rule-editor v-if="ruleDialogVisible" v-model="currentRule" :is-editing="isEditing" />
    </t-dialog>
