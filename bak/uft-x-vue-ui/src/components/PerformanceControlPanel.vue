<template>
  <div class="performance-control-panel" :class="{ expanded: isExpanded }">
    ...
    <div class="panel-header" @click="toggleExpanded">
      ...
      <div class="expand-indicator" :class="{ expanded: isExpanded }">▼</div>
    </div>
    ...
    <div v-if="isExpanded" class="panel-content">
      ...
      <div class="actions-section">
        <button class="action-btn cleanup" @click="triggerCleanup">清理内存资源</button>
        <button class="action-btn reset" @click="resetSettings">重置性能设置</button>
      </div>
