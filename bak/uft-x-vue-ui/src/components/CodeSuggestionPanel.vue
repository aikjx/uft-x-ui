  ...
  <div class="code-suggestion-panel" :class="{ 'dark-theme': isDark }">
          ...
          <div class="suggestion-header" @click="toggleExpand(suggestion.id)">
            ...
            <div class="suggestion-actions">
              ...
              <t-button
                variant="text"
                size="small"
                @click.stop="showDetails(suggestion)"
              >
                详情
              </t-button>
            </div>
          ...
          <div class="suggestion-content">
            ...
            <div class="code-example" v-if="suggestion.codeExample">
              ...
              <div class="code-content">
                <pre v-if="activeTab[suggestion.id] === 'before'"><code>{{ suggestion.codeExample.before }}</code></pre>
                <pre v-if="activeTab[suggestion.id] === 'after'"><code>{{ suggestion.codeExample.after }}</code></pre>
              </div>
            </div>
    ...
    <div class="empty-state" v-else>
      <t-empty description="暂无优化建议">
        <t-button variant="outline" @click="refreshSuggestions">
          重新分析
        </t-button>
      </t-empty>
    </div>
    ...
    >
      ...
      <template #footer>
        <t-button variant="outline" @click="detailDialog.visible = false">
          关闭
        </t-button>
        <t-button
          variant="primary"
