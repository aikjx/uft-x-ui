...
export interface VisualizationState {
  ...
  /** 设置选中的可视化类型 */
  setSelectedVisualization: (visualization: 'spiral' | 'cylindrical' | 'impedance' | 'quantum' | 'theory') => void;
  /** 更新性能指标 */
...
export const useVisualizationState = create<VisualizationState>()(
  persist(
    immer((set) => ({
      ...
      setPlay: (playing) => set((state) => {
        state.isPlaying = playing;
      }),
      
      setSelectedVisualization: (visualization) => set((state) => {
