...
export class UnifiedPerformanceManager {
  ...
  public autoOptimize(): void {
    ...
    // 只应用高优先级的优化建议
    const highPriorityRecommendations = analysis.recommendations.filter(rec => rec.priority === 'high');
    ...
    this.log('Auto-optimization completed. Applied ' + highPriorityRecommendations.length + ' high-priority recommendations.', null, 'info');
  }
