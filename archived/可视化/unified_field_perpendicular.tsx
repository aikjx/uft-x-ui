...
const UnifiedFieldVisualization = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (isAnimating) {
        ...
        // 三个点沿各自垂直轴做圆周运动
        pointX.position.set(0, radius * Math.sin(time), radius * Math.cos(time))
  ...
  return (
    <div className="flex h-screen w-full flex-col bg-black">
      ...
      <div className="border-t-4 border-red-500 bg-gray-900 p-6">
        <div className="mb-4 flex flex-wrap items-center justify-center gap-4">
          <button
            onClick={() => setIsAnimating(!isAnimating)}
            className="rounded-lg bg-gradient-to-r from-red-600 to-red-700 px-8 py-3 text-lg font-bold text-white shadow-lg transition-all hover:from-red-700 hover:to-red-800"
          >
          ...
          <button
            ...
            className="rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-3 text-lg font-bold text-white shadow-lg transition-all hover:from-blue-700 hover:to-blue-800"
          >
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-3 gap-4">
          <div className="rounded-lg border-2 border-red-500 bg-red-900 bg-opacity-30 p-4">
            <div className="mb-2 flex items-center gap-3">
              <div className="h-6 w-6 animate-pulse rounded-full bg-red-500"></div>
              <span className="text-xl font-bold text-white">X轴运动点</span>
            </div>
            <p className="text-sm text-red-200">在YZ平面做圆周运动</p>
          </div>

          <div className="rounded-lg border-2 border-green-500 bg-green-900 bg-opacity-30 p-4">
            <div className="mb-2 flex items-center gap-3">
              <div className="h-6 w-6 animate-pulse rounded-full bg-green-500"></div>
              <span className="text-xl font-bold text-white">Y轴运动点</span>
            </div>
            <p className="text-sm text-green-200">在XZ平面做圆周运动</p>
          </div>

          <div className="rounded-lg border-2 border-blue-500 bg-blue-900 bg-opacity-30 p-4">
            <div className="mb-2 flex items-center gap-3">
              <div className="h-6 w-6 animate-pulse rounded-full bg-blue-500"></div>
              <span className="text-xl font-bold text-white">Z轴运动点</span>
            </div>
            <p className="text-sm text-blue-200">在XY平面做圆周运动</p>
          </div>
        </div>
      </div>

      <div className="border-t border-gray-700 bg-black p-4 text-center">
