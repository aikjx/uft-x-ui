...
const CylindricalSpiralField = () => {
    ...
    const createCylindricalSpiralField = () => {
      ...
      directions.forEach((dir, spiralIdx) => {
        ...
        for (let i = 0; i <= config.particleDensity; i++) {
          ...
          const angle =
            t * config.rotations * Math.PI * 2 * config.angularSpeed * config.helixTightness
  ...
  return (
    <div className="relative flex h-screen w-full flex-col overflow-hidden bg-gradient-to-b from-black via-slate-950 to-blue-950">
      ...
      <div className="absolute left-0 right-0 top-0 z-10 bg-gradient-to-b from-black/95 via-black/70 to-transparent p-6">
        <h1 className="mb-2 bg-gradient-to-r from-orange-400 via-yellow-300 to-cyan-400 bg-clip-text text-5xl font-bold text-transparent">
          统一场论·圆柱螺旋发散
        </h1>
        <p className="mb-1 text-lg text-cyan-300/90">
          Unified Field - Cylindrical Spiral Divergence from Origin
        </p>
        <p className="text-sm text-blue-300/70">
          从原点(0,0,0)向空间四面八方发散，每个方向保持恒定半径的圆柱螺旋运动
        </p>
      </div>

      <div ref={containerRef} className="z-5 relative flex-1" />

      <div className="absolute bottom-0 left-0 right-0 z-10 max-h-[45vh] overflow-y-auto bg-gradient-to-t from-black/95 via-black/80 to-transparent p-6">
        <div className="mx-auto max-w-7xl">
          <div className="mb-4 grid grid-cols-4 gap-3">
            <div className="rounded-lg border-2 border-orange-500/70 bg-gradient-to-br from-orange-900/60 to-red-900/60 p-3 backdrop-blur-md">
              <label className="mb-2 block text-xs font-bold text-orange-300">🌐 发散方向数</label>
              <input
                type="range"
                min="8"
                max="64"
                ...
                className="mb-1 h-2 w-full cursor-pointer appearance-none rounded-lg bg-orange-700/50"
              />
            ...
            <div className="rounded-lg border-2 border-cyan-500/70 bg-gradient-to-br from-cyan-900/60 to-blue-900/60 p-3 backdrop-blur-md">
              <label className="mb-2 block text-xs font-bold text-cyan-300">⭕ 圆柱半径</label>
              <input
                type="range"
                min="1"
                max="8"
                ...
                className="mb-1 h-2 w-full cursor-pointer appearance-none rounded-lg bg-cyan-700/50"
              />
              <div className="flex justify-between text-xs">
            ...
            <div className="rounded-lg border-2 border-purple-500/70 bg-gradient-to-br from-purple-900/60 to-pink-900/60 p-3 backdrop-blur-md">
              <label className="mb-2 block text-xs font-bold text-purple-300">📏 发散长度</label>
              <input
                type="range"
                min="15"
                max="50"
                ...
                className="mb-1 h-2 w-full cursor-pointer appearance-none rounded-lg bg-purple-700/50"
              />
              <div className="flex justify-between text-xs">
            ...
            <div className="rounded-lg border-2 border-yellow-500/70 bg-gradient-to-br from-yellow-900/60 to-amber-900/60 p-3 backdrop-blur-md">
              <label className="mb-2 block text-xs font-bold text-yellow-300">🌀 旋转圈数</label>
              <input
                type="range"
                min="2"
                max="20"
                ...
                className="mb-1 h-2 w-full cursor-pointer appearance-none rounded-lg bg-yellow-700/50"
              />
              <div className="flex justify-between text-xs">
            ...
            <div className="rounded-lg border-2 border-green-500/70 bg-gradient-to-br from-green-900/60 to-emerald-900/60 p-3 backdrop-blur-md">
              <label className="mb-2 block text-xs font-bold text-green-300">⚡ 角速度 ω</label>
              <input
                type="range"
                min="0.2"
                max="3"
                ...
                className="mb-1 h-2 w-full cursor-pointer appearance-none rounded-lg bg-green-700/50"
              />
              <div className="flex justify-between text-xs">
                <span className="text-green-200/70">0.2</span>
                <span className="text-sm font-bold text-green-100">
                  {config.angularSpeed.toFixed(1)}
                </span>
                <span className="text-green-200/70">3.0</span>
              </div>
            </div>

            <div className="rounded-lg border-2 border-teal-500/70 bg-gradient-to-br from-teal-900/60 to-cyan-900/60 p-3 backdrop-blur-md">
              <label className="mb-2 block text-xs font-bold text-teal-300">🔧 螺旋紧密度</label>
              <input
                type="range"
                min="0.5"
                max="2"
                ...
                className="mb-1 h-2 w-full cursor-pointer appearance-none rounded-lg bg-teal-700/50"
              />
              <div className="flex justify-between text-xs">
                <span className="text-teal-200/70">0.5</span>
                <span className="text-sm font-bold text-teal-100">
                  {config.helixTightness.toFixed(1)}
                </span>
                <span className="text-teal-200/70">2.0</span>
              </div>
            </div>

            <div className="rounded-lg border-2 border-blue-500/70 bg-gradient-to-br from-blue-900/60 to-indigo-900/60 p-3 backdrop-blur-md">
              <label className="mb-2 block text-xs font-bold text-blue-300">✨ 粒子密度</label>
              <input
                type="range"
                min="50"
                max="250"
                ...
                className="mb-1 h-2 w-full cursor-pointer appearance-none rounded-lg bg-blue-700/50"
              />
              <div className="flex justify-between text-xs">
            ...
            <div className="rounded-lg border-2 border-red-500/70 bg-gradient-to-br from-red-900/60 to-rose-900/60 p-3 backdrop-blur-md">
              <label className="mb-2 block text-xs font-bold text-red-300">🔥 场强度</label>
              <input
                type="range"
                min="1"
                max="10"
                ...
                className="mb-1 h-2 w-full cursor-pointer appearance-none rounded-lg bg-red-700/50"
              />
              <div className="flex justify-between text-xs">
          ...
          <div className="flex items-center justify-between rounded-xl border-2 border-cyan-500/50 bg-black/80 p-4 backdrop-blur-md">
            <button
              onClick={() => setIsPlaying(!isPlaying)}
              className="rounded-xl border-2 border-white/30 bg-gradient-to-r from-orange-500 via-yellow-500 to-cyan-500 px-10 py-3 text-lg font-bold text-white transition-all hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/50"
            >
              {isPlaying ? '⏸ 暂停' : '▶ 播放'}
            </button>
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-white/50">从原点(0,0,0)球面发散 | 圆柱螺旋轨迹</div>
            </div>
          </div>
        </div>
      </div>
