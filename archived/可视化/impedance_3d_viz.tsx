  ...
  return (
    <div className="relative h-screen w-full bg-black">
      ...
      <button
        ...
        className="absolute right-4 top-4 rounded-lg bg-cyan-500 px-4 py-2 font-semibold text-black transition-colors hover:bg-cyan-600"
      >
        {showInfo ? 'Hide' : 'Show'} Info
      </button>

      {showInfo && (
        <div className="absolute left-4 top-4 max-w-md rounded-lg border border-cyan-500 bg-gray-900 bg-opacity-90 p-6 text-white backdrop-blur-sm">
          <h2 className="mb-4 text-2xl font-bold text-cyan-400">Vacuum Impedance Z'</h2>
          ...
          <div className="space-y-3 text-sm">
            ...
            <p className="mt-4 text-xs text-gray-300">Z' ≈ 29.98 Ω (approximately 30 ohms)</p>
