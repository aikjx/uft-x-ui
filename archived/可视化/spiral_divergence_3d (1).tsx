  ...
  return (
    <div className="flex h-screen w-full flex-col bg-gray-900">
      <div className="bg-gradient-to-r from-blue-900 via-purple-900 to-pink-900 p-5 text-white">
        <h1 className="mb-3 text-3xl font-bold">3D Isotropic Cylindrical Spiral Divergence</h1>
        <div className="grid grid-cols-1 gap-2 text-sm md:grid-cols-3">
          <div className="rounded bg-black bg-opacity-30 p-2">
      ...
      <div className="relative flex-1" ref={mountRef}>
        <div className="absolute right-4 top-4 z-10 w-72 space-y-4 rounded-xl bg-black bg-opacity-85 p-5 text-white shadow-2xl">
          <h3 className="border-b border-blue-500 pb-2 text-xl font-bold">Control Panel</h3>
          ...
          <div className="flex items-center space-x-3 rounded-lg bg-gray-800 p-3">
            ...
            />
            <label htmlFor="cylinders" className="cursor-pointer text-sm">
          ...
          <button
            ...
            className="w-full rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-5 py-3 text-lg font-bold shadow-lg transition-all hover:from-blue-700 hover:to-purple-700"
          >
            {isAnimating ? 'PAUSE' : 'PLAY'}
          </button>

          <div className="space-y-2 rounded-lg border-t border-gray-700 bg-gray-800 p-3 pt-3 text-xs">
            <p className="mb-2 text-sm font-bold text-blue-300">Visualization Features:</p>
        ...
        <div className="absolute bottom-4 left-4 z-10 rounded-xl bg-black bg-opacity-85 p-4 text-xs text-white shadow-2xl">
          <p className="mb-2 text-sm font-bold text-yellow-300">
            Cylindrical Helix Characteristics:
          </p>
