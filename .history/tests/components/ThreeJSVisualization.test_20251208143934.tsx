...
describe('ThreeJSVisualization - 3D 可视化组件', () => {
  beforeEach(() => {
    ...
    // 完整模拟 WebGL 环境
    // 模拟 WebGLRenderingContext
    window.WebGLRenderingContext = vi.fn() as any
    ...
    // 模拟 experimental-webgl
    window.WebGLRenderingContext = window.WebGLRenderingContext || ({} as any)
