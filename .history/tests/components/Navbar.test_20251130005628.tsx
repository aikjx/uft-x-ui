...
describe('Navbar - 导航菜单组件', () => {
  ...
  it('应该正确高亮公式可视化菜单项', () => {
    ...
    useLocation.mockReturnValue({ pathname: '/formulas', search: '', hash: '', state: null });
  ...
  it('应该正确高亮人工场技术菜单项', () => {
    // 手动设置useLocation返回值
    const useLocation = require('react-router-dom').useLocation;
    useLocation.mockReturnValue({ pathname: '/artificial-field', search: '', hash: '', state: null });
  ...
  it('应该正确高亮交互探索菜单项', () => {
    // 手动设置useLocation返回值
    const useLocation = require('react-router-dom').useLocation;
    useLocation.mockReturnValue({ pathname: '/interactive', search: '', hash: '', state: null });
