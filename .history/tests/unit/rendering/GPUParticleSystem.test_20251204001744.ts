...
// 模拟Vector3的toArray方法
vi.spyOn(THREE.Vector3.prototype, 'toArray').mockReturnValue([0, 0, 0]);

// 模拟Color的toArray方法和r、g、b属性
vi.spyOn(THREE.Color.prototype, 'toArray').mockReturnValue([0, 0, 0]);
Object.defineProperty(THREE.Color.prototype, 'r', { value: 0, writable: true });
Object.defineProperty(THREE.Color.prototype, 'g', { value: 0, writable: true });
Object.defineProperty(THREE.Color.prototype, 'b', { value: 0, writable: true });

// 模拟BufferGeometry的setAttribute方法
vi.spyOn(THREE.BufferGeometry.prototype, 'setAttribute').mockImplementation(() => {});

// 模拟ShaderMaterial
vi.spyOn(THREE, 'ShaderMaterial').mockImplementation(() => ({
  uniforms: {},
  dispose: vi.fn()
}));

// 模拟Points
vi.spyOn(THREE, 'Points').mockImplementation(() => ({
  add: vi.fn(),
  remove: vi.fn()
}));
