...
import { AIPerformanceEngine, aiPerformanceEngine, PerformanceMetrics as AIPerformanceMetrics } from './aiPerformanceEngine';
...
export class UnifiedPerformanceManager {
  ...
  private aiPerformanceEngine: AIPerformanceEngine;
  ...
  private constructor(config: Partial<UnifiedPerformanceConfig> = {}) {
    ...
    this.aiPerformanceEngine = aiPerformanceEngine;
