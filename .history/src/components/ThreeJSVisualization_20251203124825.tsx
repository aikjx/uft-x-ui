    ...
    try {
      ...
      materialsToGeometries.forEach((geometries, material) => {
        ...
        if (geometries[0] instanceof THREE.BufferGeometry) {
          ...
          mergedGeometry = BufferGeometryUtils.mergeBufferGeometries(geometries as THREE.BufferGeometry[]);
        } else {
          // 合并传统Geometry - 注意：Three.js r125+已不再支持Geometry类，这里使用BufferGeometry
          mergedGeometry = BufferGeometryUtils.mergeBufferGeometries(geometries as THREE.BufferGeometry[]);
        }
