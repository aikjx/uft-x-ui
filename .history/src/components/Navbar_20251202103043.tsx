      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <button
            ...
            className="md:hidden p-3 rounded-lg text-gray-400 hover:text-white hover:bg-gray-800/50 transition-colors hover:scale-95 active:scale-90"
          >
        ...
        {/* Mobile Navigation */}
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-700/50 bg-gray-900/95 backdrop-blur-xl animate-fade-in-down">
