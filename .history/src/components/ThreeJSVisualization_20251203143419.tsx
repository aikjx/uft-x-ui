...
import type { Scene, PerspectiveCamera, WebGLRenderer, Mesh, BufferGeometry, Material, Light, Object3D, Texture, PointLight, SpotLight, DirectionalLight, AmbientLight } from 'three';
