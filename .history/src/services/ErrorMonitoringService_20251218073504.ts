...
import { Injectable, ServiceLifetime } from './ServiceContainer';
...
export class ErrorMonitoringService {
  ...
  private categorizeError(error: any): ErrorCategory {
    ...
    } else if (errorMessage.includes('state') || errorMessage.includes('hook') || errorMessage.includes('use')) {
      return ErrorCategory.STATE;
    } else if (errorMessage.includes('render') || errorMessage.includes('component') || errorMessage.includes('element')) {
      return ErrorCategory.RENDER;
    } else if (errorMessage.includes('performance') || errorMessage.includes('timeout') || errorMessage.includes('slow')) {
