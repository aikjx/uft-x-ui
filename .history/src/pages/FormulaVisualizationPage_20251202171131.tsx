...
const FormulaVisualizationPage: React.FC = () => {
  ...
  return (
    <motion.div
      className="relative w-full min-h-[calc(100vh)] flex flex-col bg-[#0a0a14] py-0"
      variants={containerVariants}
      initial="hidden"
      animate="visible"
    >
        <div className="container flex flex-col gap-0 px-2 mx-auto lg:flex-row lg:gap-4">
          {/* 左侧公式列表 - 改进响应式布局 */}
          <motion.div
            className="lg:w-64 bg-gradient-to-br from-[#121228] to-[#0f0f20] rounded-2xl p-3 border border-blue-900/30 h-fit sticky top-2 lg:max-h-[90vh] overflow-hidden flex flex-col shadow-xl shadow-blue-900/5"
          ...
          {/* 右侧可视化和详情 - 改进响应式布局，突出可视化区域 */}
          <motion.div
            className="flex flex-col flex-1"
            variants={itemVariants}
          >
            {/* 公式详情 - 精简高度，让更多空间留给可视化 */}
            <motion.div
              className="bg-gradient-to-br from-[#121228] to-[#0f0f20] rounded-2xl p-4 border border-blue-900/30 mb-3 shadow-xl shadow-blue-900/10 hover:shadow-blue-900/20 transition-all duration-300"
            ...
            <div className="flex-1 bg-[#0a0a14] rounded-2xl border border-blue-900/30 overflow-hidden relative min-h-[calc(100vh-10rem)] shadow-xl shadow-blue-900/10 transition-all duration-300">
              {/* 加载覆盖层 */}
              {isLoading && (
              ...
              {/* 可视化信息提示 - 精简设计 */}
              <div className="absolute bottom-2 left-2 bg-[#0a0a14]/90 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-blue-900/30 text-xs text-blue-200/80">
