...
const HomePage: React.FC = () => {
  return (
    <div className="w-full">
      {/* 英雄区域 - 增强版响应式设计 */}
      <section className="overflow-hidden relative pt-12 pb-16 text-center md:pt-20 md:pb-28 lg:pt-28 lg:pb-36">
        {/* 动态背景网格 - 增强版 */}
        ...
        <div className="relative z-10 px-4 mx-auto max-w-6xl">
          ...
          <motion.h1 
            className="mb-8 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 md:text-4xl lg:text-6xl"
