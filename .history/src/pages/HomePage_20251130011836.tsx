    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 md:py-32 text-center overflow-hidden">
        ...
        >
          <motion.div variants={itemVariants} className="mb-6">
            <motion.span 
              ...
              className="inline-block px-6 py-3 bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-300 rounded-full text-sm font-medium border border-blue-500/30 backdrop-blur-sm"
            >
              🌌 统一场论探索
            </motion.span>
          </motion.div>
          ...
          >
            <motion.div
              whileHover={{ scale: 1.05, boxShadow: "0 20px 25px -5px rgba(59, 130, 246, 0.2), 0 10px 10px -5px rgba(59, 130, 246, 0.1)" }}
              whileTap={{ scale: 0.98 }}
            >
              <Link
                to="/formulas"
        ...
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-48 h-48 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            rotate: -360,
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 w-32 h-32 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full blur-2xl"
        />
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 justify-center">
              <motion.div
                whileHover={{ scale: 1.05, boxShadow: "0 20px 25px -5px rgba(34, 197, 94, 0.2), 0 10px 10px -5px rgba(34, 197, 94, 0.1)" }}
                whileTap={{ scale: 0.98 }}
              >
                <Link
                  to="/interactive"
