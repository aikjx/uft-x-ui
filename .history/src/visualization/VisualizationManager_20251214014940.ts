...
export class VisualizationManager {
  ...
  private constructor(config: Partial<VisualizationConfig> = {}) {
    ...
    this.config = {
      ...
      camera: {
        fov: VISUALIZATION_CONFIG.fov || 75,
        near: VISUALIZATION_CONFIG.near || 0.1,
        far: VISUALIZATION_CONFIG.far || 1000,
        position: new THREE.Vector3(0, 0, 5),
        lookAt: new THREE.Vector3(0, 0, 0),
        ...config.camera
      },
   ...
   * 保存预设
   */
  public savePreset(preset: Omit<VisualizationPreset, 'id' | 'createdAt' | 'updatedAt'>): string {
