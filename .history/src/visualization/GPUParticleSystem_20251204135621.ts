...
export class GPUParticleSystem {
  ...
  private vertexShader = `
    ...
    void main() {
      ...
      // 点大小计算 - 进一步简化
      vSize = size * mix(startSize, endSize, lifeProgress);
      gl_PointSize = vSize * (300.0 / -mvPosition.z);
      
      // 颜色计算 - 预计算透明度
      vColor = vec4(mix(startColor, endColor, lifeProgress), decay);
  ...
  // 优化后的片段着色器 - 进一步优化性能，使用更高效的圆形渲染算法
