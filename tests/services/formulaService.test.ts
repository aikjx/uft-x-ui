...
describe('FormulaService - 公式处理服务', () => {
  ...
  describe('公式解析', () => {
    ...
    it('应该支持特殊数学符号', () => {
      const formulas = ['∫ f(x) dx', '∑_{i=1}^n i', '∇·E = ρ/ε₀', 'e^{iπ} + 1 = 0']
  ...
  describe('公式验证', () => {
    it('应该验证变量命名规范', () => {
      const validFormulas = ['E = mc^2', 'F = ma', 'v = dx/dt']
    ...
    it('应该检测语法错误', () => {
      const invalidFormulas = ['E = m * c^', 'F = m * a +', 'v = dx//dt']
  ...
  describe('公式计算', () => {
    ...
    it('应该处理单位转换', () => {
      const result = formulaService.evaluateWithUnits(
        'E = mc^2',
